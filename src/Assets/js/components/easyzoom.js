    ...
    (this.$link = this.$target.find("a")),
      ...
      this.$target
        .on("mouseenter.easyzoom touchstart.easyzoom", function(a) {
          (a.originalEvent.touches && 1 !== a.originalEvent.touches.length) ||
            (a.preventDefault(), b.show(a));
        })
    ...
    (b.prototype.show = function(a) {
      ...
      return this.isReady
        ? (this.$target.append(this.$flyout),
          ...
          (c = this.$zoom.width() - h),
          (d = this.$zoom.height() - i),
          (e = c / b),
          (f = d / g),
          (this.isOpen = !0),
          this.opts.onShow && this.opts.onShow.call(this),
          void (a && this._move(a)))
        : void this._load(this.$link.attr("href"), function() {
            j.show(a);
          });
    }),
      ...
      this.$target
        ...
        (e.onload = function() {
          0 !== e.width &&
            ((d.isReady = !0),
            d.$notice.detach(),
            d.$flyout.html(d.$zoom),
            d.$target.removeClass("is-loading").addClass("is-ready"),
            c());
        }),
