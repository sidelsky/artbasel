...
$value_title = 'hauserwirth';
$button_title = 'Submit';
$placeholder_title = "Please Enter Your Password"
...
<div class="tml tml-login" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form name="loginform" id="loginform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'login', 'login_post' ); ?>" method="post">
		<p class="tml-user-login-wrap">
			...
			*/ ?>
			<input type="text" name="log" id="user_login<?php $template->the_instance(); ?>" class="input username" value="<?= $value_title; ?>" size="20" />
		</p>

		<p class="tml-user-pass-wrap">
			<?php /* <label for="user_pass<?php $template->the_instance(); ?>"><?php _e( 'Password', 'theme-my-login' ); ?></label> */ ?>
			<input type="password" name="pwd" id="user_pass<?php $template->the_instance(); ?>" class="input" value="" size="20" autocomplete="off" placeholder="<?= $placeholder_title ?>" />
		</p>
		...
		<div class="tml-rememberme-submit-wrap">
			...
			<p class="tml-submit-wrap">
				...
				*/ ?>
				<input type="submit" class="submit" name="wp-submit" id="wp-submit<?php $template->the_instance(); ?>" value="<?= $button_title ?>" disabled="disabled" />
