<?php if( $data['widerTextContent'] ) : ?>
	...
	<section class="u-section">
		<div class="u-l-container<?= $args['alignLeft'] ? '--1150' : '--shallow'?> u-l-vertical-padding--medium40 u-l-horizontal-padding--medium l-content__block__text-content--wide <?= $args['alignLeft'] ? 'u-l-container--no-margin' : ''?>">  
