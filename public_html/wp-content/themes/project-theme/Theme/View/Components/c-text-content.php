<article class="l-content__block l-content__block__text-content <?= is_page_template('page-viewing-room.php' || 'page-private-sales-sub.php') || is_singular('private-room') ? 'l-content__block--wide-text' : '' ?> <?= $data['darkBackground'] ? 'l-content__block--dark-background' : ''; ?>">
