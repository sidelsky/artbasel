 ...
 */
 ...
 // Get sub field values.
 			 $video = get_sub_field('video-hero');
 ?>
 	<div id="hero-wrap" style="background: url('<?php echo esc_url( $video['url'] ); ?>');  background-size: cover;">
 ...
 <div id="product-content">
 		<div id="product-wrap" class="slow wow fadeInUp"  data-wow-delay=".05s" data-wow-duration="2s" style="visibility: visible; animation-delay: .05s;  animation-name: fadeInUp;">
 					...
 					<div class="product-main">
 						...
 						<?php echo do_shortcode('[products per_page="8" columns="4" show_catalog_ordering="yes" orderby="rand"  pagination="true"]'); ?>
 					</div>
