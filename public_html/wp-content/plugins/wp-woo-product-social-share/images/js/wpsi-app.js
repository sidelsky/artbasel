...
jQuery(document).ready(function($) {
	...
	$("#wpsi_buttons_position").select2();

	$("#wpsi_buttons_icontext_field").select2();
	...
	$("#social_service_toggle_btn").click(function(event) {
		...
		var values = $("#wpsi_buttons_list_field_values").val();
		try{
	...
	$("#myModal .close").click(function(event) {
		...
		$("input#wpsi_buttons_list_field_values").val(null);
		...
		$("input#wpsi_buttons_list_field_values").val(selected);
